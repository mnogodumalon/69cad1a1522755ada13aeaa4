...
export function MitarbeiterverwaltungDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = true, enablePhotoLocation = true }: MitarbeiterverwaltungDialogProps) {
  ...
  async function handlePhotoScan(file: File) {
    ...
    try {
      ...
      const schema = `{\n  "vorname": string | null, // Vorname\n  "nachname": string | null, // Nachname\n  "personalnummer": string | null, // Personalnummer\n  "abteilung": LookupValue | null, // Abteilung (select one key: "montage" | "installation" | "wartung" | "buero" | "lager") mapping: montage=Montage, installation=Installation, wartung=Wartung, buero=Büro, lager=Lager\n  "telefon": string | null, // Telefon\n  "email": string | null, // E-Mail\n}`;
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              value={lookupKey(fields.abteilung) ?? 'none'}
              onValueChange={v => setFields(f => ({ ...f, abteilung: v === 'none' ? undefined : v as any }))}
            >
              <SelectTrigger id="abteilung"><SelectValue placeholder="Auswählen..." /></SelectTrigger>
              <SelectContent>
