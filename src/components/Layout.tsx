...
const navigation = [
  ...
  { name: 'Werkzeugausgabe', href: '/werkzeugausgabe', icon: IconFileText },
  { name: 'Werkzeugkatalog', href: '/werkzeugkatalog', icon: IconFileText },
  { name: 'Wartungs- und Prüfungsprotokoll', href: '/wartungs-und-pruefungsprotokoll', icon: IconFileText },
  { name: 'Mitarbeiterverwaltung', href: '/mitarbeiterverwaltung', icon: IconUsers },
];

const externalNavigation = [
  { name: 'Werkzeugausgabe', href: '/gateway/apps/69cad17f38d0c82b5c927890?template=list_page', icon: IconFileText },
  { name: 'Werkzeugkatalog', href: '/gateway/apps/69cad17fbc61d7b098886b2a?template=list_page', icon: IconFileText },
  { name: 'Wartungs- und Prüfungsprotokoll', href: '/gateway/apps/69cad18020509e2c547db87c?template=list_page', icon: IconFileText },
  { name: 'Mitarbeiterverwaltung', href: '/gateway/apps/69cad17797a950c659be4580?template=list_page', icon: IconUsers },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69cad17f38d0c82b5c927890?template=list_page"
